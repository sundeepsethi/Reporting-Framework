sap.ui.define([
		...
		return BaseObject.extend("metro.gwf.reporting.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias metro.gwf.reporting.model.ListSelector
			 */
			 ...
			 * @return {metro.gwf.reporting.model.ListSelector} the list selector object for method chaining
			 * @public
			 */

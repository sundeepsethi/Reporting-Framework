...
sap.ui.define([
		...
		return BaseController.extend("metro.gwf.reporting.controller.Master", {
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("ReportKeyword");
			...
			_showDetail : function (oItem) {
				...
				this.getRouter().navTo("object", {
					objectId : oItem.getBindingContext().getProperty("ReportKeyword")
				}, bReplace);
			},
